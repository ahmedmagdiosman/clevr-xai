...
parser.add_argument(
    "--output_mask_dir",
    default="../output/mask/",
    help="The directory where output objects' mask/segmentation will be stored. It will be "
    + "created if it does not exist.",
)
parser.add_argument(
    "--output_scene_dir",
...
def render_scene(
    ...
    objects, blender_objects = add_random_objects(
        scene_struct, num_objects, args, camera, output_mask=output_mask
    )
...
def add_random_objects(scene_struct, num_objects, args, camera, output_mask="mask.png"):
    """
  ...
  """
    ...
    all_visible = check_visibility(
        blender_objects, objects, args.min_pixels_per_object, output_mask=output_mask
    )
    if not all_visible:
...
def check_visibility(
    blender_objects, objects, min_pixels_per_object, output_mask="mask.png"
):
    """
  ...
  """
    ...
    object_colors_list = render_shadeless(blender_objects, path=output_mask)
    ...
    # All objects are visible, add the unique mask color to the object list
    for i, obj in enumerate(objects):
        obj["mask_color"] = object_colors_list[i]
...
def render_shadeless(blender_objects, path="flat.png"):
  ...
  """
    ...
    object_colors = set()
    # Also keeping a list of the mask colors to preserve insertion order.
    # This is important for mapping mask colors back to the objects.
    object_colors_list = []
    old_materials = []
    for i, obj in enumerate(blender_objects):
        ...
        object_colors_list.append((r, g, b))
